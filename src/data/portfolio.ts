...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/hatching-budget-app.jpg",
    imageAlt: "Hatching budget tracking app dashboard shown across two phones against a purple background",
    imageLabel: "HATCHING-BUDGET-APP.JPG",
  },
  {
    num: "03",
  ...
  },
  {
    ...
    bg: "#D71920",
    fg: "#fff",
    desc: "A transit app redesign with a sleek, intuitive interface for navigating public transport schedules and information.",
    top: "228px",
    slot: "proj_5",
    tags: ["UI/UX", "TRANSIT APP"],
    href: "https://www.behance.net/gallery/194608861/M-Indicator-app-redesign-UIUX",
    image: "/m-indicator-transit-app.jpg",
    imageAlt: "M-Indicator Mumbai transit app displayed on a phone held beside public transport",
    imageLabel: "M-INDICATOR-TRANSIT-APP.JPG",
  },
];
